...
var XarrowAnchors = function (props) {
  // let startPoints: t1[];
  // let endPoints: t1[];
  var startAnchors = (0, react_1.useMemo)(
    function () {
      return (0, exports.parseAnchor)(props.startAnchor);
    },
    [props.startAnchor]
  );
...
var parseAnchor = function (anchor) {
  ...
  anchorChoice2 = anchorChoice2.filter(function (an) {
    return (
      (lodash_1.default.isString(an) && (0, utils_1.isPercentStr)(an)) ||
      (lodash_1.default.isObject(an) && constants_1.cAnchorEdge.includes(an === null || an === void 0 ? void 0 : an.position))
    );
  });
...
var calcAnchors = function (anchors, anchorPos) {
  ...
  var newAnchors = anchors.map(function (anchor) {
    ...
    var _a = (0, utils_1.xStr2absRelative)(anchor.offset.inwards),
      absInw = _a.abs,
      relInw = _a.relative;
    ...
    var _b = (0, utils_1.xStr2absRelative)(anchor.offset.sidewards),
      absSidw = _b.abs,
      relSidw = _b.relative;
