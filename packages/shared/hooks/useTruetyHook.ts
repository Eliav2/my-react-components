...
/**
 * any hook,just with dependency list of booleans, if the dependency list includes true value the callback would be executed by the provided hook
 * @param hook - like useEffect,useCallback ,etc
 * @param callback - () => console.log('hello world')
 * @param conditions - like [false,true,false]
 */
export const useTruetyHook = (
  hook = useLayoutEffect as any,
  callback: Function,
